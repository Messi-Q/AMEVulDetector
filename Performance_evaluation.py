...
slither_label = read_label("slither_label.txt", line_parse_fn=lambda s: int(float(s.strip())))
...
tn, fp, fn, tp = confusion_matrix(ground_truth, slither_label).ravel()
